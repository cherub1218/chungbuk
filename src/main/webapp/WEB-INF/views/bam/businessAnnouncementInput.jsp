...
$(document).ready(function(){
	$('#submit_Btn').click(function(){
		...
		const check_content = CKEDITOR.instances.anc_remark.getData();
        	...
        	<c:choose>
                ...
                <div class="cont">
                    ...
                    <div class="inner">
                        ...
                        <form id="writeForm" name="writeForm" method="post" action="<c:url value="/bam/businessAnnouncementInputWrite"/>" enctype="multipart/form-data">
