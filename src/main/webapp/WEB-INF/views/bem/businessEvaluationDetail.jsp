...
<head>
 ...
 <script type="text/javascript">
 	...
 	function printFn(print){
 	     ...
 	     var xpos=(sw-w)/2; 
 	     var ypos=(sh-h)/2; 
 	     var pHeader="<html><head><link rel='stylesheet' type='text/css' href='${pageContext.request.contextPath}/resource/css/sub.css'><link rel='stylesheet' type='text/css' href='${pageContext.request.contextPath}/resource/css/reset.css'><title>" + print + "</title></head><body>"; 	     
                    ...
                    <ul>
                       ...
                       <c:if test="${member.user_auth != 0}">
                        <li class="on">
                            ...
                            <ul class="second_menu">
                                <li class="on"><a href="<c:url value="/bem/businessEvaluationMyList"/>">· 평가내역 조회</a></li>
                            </ul>
                            </li>
                      </c:if>
                    </ul>
                        ...
                        <div class="cont">
                            ...
                            <div class="table_wrap" id="table_wrap">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="ta_c"><c:out value="${bamnotice.anc_title}"/></td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <button type="button" class="normal" style="float: left;" onclick="location.href='<c:url value="/bem/businessEvaluationMyList"/>'">목록</button>
                                <button type="button" class="normal"  onclick="location.href='<c:url value="/bem/businessEvaluationUpdate"/>?bem_beval_idx=${read.bem_beval_idx}&bpm_bplan_idx=${param.bpm_bplan_idx}&bam_anc_idx=${param.bam_anc_idx}'"> 수정</button>
